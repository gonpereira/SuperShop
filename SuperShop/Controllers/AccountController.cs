    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Register()
        {
            var model = new RegisterNewUserViewModel
            {
                ...
                Cities = _countryRepository.GetComboCities(0) //vai por a lista vazia...
            };
        ...
        public async Task<IActionResult> Register(RegisterNewUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    {
                        ViewBag.Message = "The instructions to allow you, has been sent to your email";
                        return View(model);
                    }
            ...
            if (this.ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        var credentials = new SigningCredentials(key, SecurityAlgorithms.HmacSha256); //gera o token 256 bits ssl
